...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/08 13:41:10 by rhvidste          #+#    #+#             */
/*   Updated: 2026/02/08 15:18:20 by rhvidste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include"bigint03.hpp"
//CONSTRUCTORS
...
{
  bigint temp = *this;
  temp = *this << stringToUINT( other.getStr() );
  return ( temp );
}
...
bigint&     bigint::operator  <<= ( const bigint& other )
{
  *this = *this << stringToUINT( other.getStr() );
  return ( *this );
}
bigint&     bigint::operator  >>= ( const bigint& other )
{
