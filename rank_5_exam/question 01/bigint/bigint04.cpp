...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/08 15:26:27 by rhvidste          #+#    #+#             */
/*   Updated: 2026/02/09 10:39:44 by rhvidste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include"bigint04.hpp"

//---------------------------------------------------------------CONSTRUCTORS
bigint::bigint(){ this->_str = "0"; }
...
//---------------------------------------------------------------------GETTER
std::string bigint::getStr()                                  const{ return( this->_str ); }
...
{
  bigint temp = *this;
  temp = *this << strToUINT( other.getStr() );
  return ( temp );
}
...
bigint&     bigint::operator  <<= ( const bigint& other )
{
  *this = *this << strToUINT( other.getStr() );
  return ( *this );
}
